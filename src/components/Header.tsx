...
const Header = () => {
  return (
    <header className="w-full h-20 bg-white border-b-2 border-black-300 py-1 px-6 flex items-center justify-between"> 
        <div className="flex items-center"> 
            ...
            <h1 className="text-2xl font-montserrat font-bold text-black">GearHub</h1>
        </div>
