...
export default function SortButton() {
  ...
  return (
    <label className="flex items-center gap-2 rounded-full border border-neutral-200 bg-white px-4 py-2.5 text-sm font-semibold text-neutral-700 shadow-sm hover:border-primary">
      ...
      >
        ...
        <ChevronDown
          size={16}
          className="pointer-events-none absolute right-0 text-neutral-900"
        />
      </span>
    </label>
  );
